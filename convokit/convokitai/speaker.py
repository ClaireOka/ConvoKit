...
class Speaker(BaseSpeaker):
    ...
    :param is_ai: whether this speaker is an AI
    :param ai_meta: dictionary of AI-specific attributes of the speaker (e.g. model, persona)
    ...
    :ivar is_ai: whether this speaker is an AI
    :ivar ai_meta: AI-specific attributes of the speaker. Assigning a dict merges it into the existing ai_meta.
    """
